...
public class BmlCrafting {
    ...
    public static void registerRecipeSerialziers(RegisterEvent event) {
        event.register(ForgeRegistries.Keys.RECIPE_SERIALIZERS, helper -> CraftingHelper.register(new ResourceLocation(Bml.MOD_ID, "nbt"), IngredientNBT.Serializer.INSTANCE));
